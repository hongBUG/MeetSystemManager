                ...
                <fieldset>
                    ...
                    <table class="formtable">
                        ...
                        <tr>
                            <td>会议说明：</td>
                            <td>
                                <textarea rows="5" id="description" readonly>${mt.description }</textarea>
                            </td>
                        </tr>
                        <tr>
                            <td>参会人员：</td>
                        ...
                        <tr>
                            <td class="command" colspan="2">
                                <c:if test="${type='cancel' }" >
                                    <input type="button" class="clickbutton" value="撤销会议" onclick="window.location.href='/meeting/cancelmeeting?mid=${mt.meetingid}';" /> 
                                </c:if>
