...
<div class="page-sidebar">
    <div class="sidebar-menugroup">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="sidebar-menuitem active"><a href="/metting/mybooking">我的预定</a></li>
            <li class="sidebar-menuitem"><a href="/metting/mymeeting">我的会议</a></li>
        </ul>
    </div>
    <c:if test="${loginUser.role==1 }">
        <div class="sidebar-menugroup">
            ...
            <ul class="sidebar-menu">
                <li class="sidebar-menuitem"><a href="departments">会议管理</a></li>
                <li class="sidebar-menuitem"><a href="reg">员工注册</a></li>
                <li class="sidebar-menuitem"><a href="approveaccount">注册审批</a></li>
                <li class="sidebar-menuitem"><a href="searchemp">搜索员工</a></li>
            </ul>
        </div>
    </c:if>
    <div class="sidebar-menugroup">
